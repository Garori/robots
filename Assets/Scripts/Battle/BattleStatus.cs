...
public class BattleStatus
{
    ...
    )
    {
        ...
        values[Commands.ONE] = 1;
        values[Commands.TWO] = 2;
        values[Commands.THREE] = 3;
        values[Commands.FOUR] = 4;
        values[Commands.FIVE] = 5;
        values[Commands.SIX] = 6;
        values[Commands.SEVEN] = 7;
        values[Commands.EIGHT] = 8;
