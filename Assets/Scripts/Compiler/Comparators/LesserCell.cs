...
[System.Serializable]
public class LesserCell : ComparatorCell
{
    ...
    public LesserCell(Commands variable1, Commands variable2, float variable1NUMBER = -1, float variable2NUMBER = -1) : base()
    {
    ...
    public override bool Evaluate(BattleStatus battleStatus)
    {
        ...
        Debug.Log($"no evaluate {aux1} e {aux2}");
        Debug.Log(variable1 != Commands.NUMBER);
        return aux1 < aux2;
    }
